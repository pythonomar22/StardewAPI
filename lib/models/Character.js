...
module.exports = class Character {
  ...
  static async updateById(id, { name, birthday, address, elligible }) {
    ...
    const { rows } = await pool.query(
      'UPDATE characters SET name=$2, birthday=$3, address=$4, elligible=$5 WHERE id=$1 RETURNING *', [id, name, birthday, address, elligible]
    )
